    ...
    return (
      <div
        className={
          styles.post +
          " " +
          (!!this.props.imageUrl || !!this.props.coin
            ? this.props.imageUrl
              ? styles.postWithImage
              : styles.postWithChart
            : styles.postWithOutImage)
        }
      >
        <div className={styles.post__foreGroundContent}>
          <div className={styles.post__container}>
            <div className={styles.post__user}>
              ...
              >
                <label className={styles.post__name}>
          ...
          {!!this.props.hideComments ? (
            ...
            <Link
              className={styles.post__userLink}
              to={"/post/" + this.props.Id + "/comments"}
            >
        ...
        <div className={styles.post__backgroundContent}>
          <div className={styles.post__container}>
            <div className={styles.post__user}>
              ...
              <div className={styles.post__global}>
                {this.props.global ? "• GLOBAL" : " • CLUSTER ONLY"}
              </div>
            </div>
            <p className={styles.post__date}>{this.getDateString(postDate)}</p>
          </div>
