        ...
        return (
          <div key={post.id} className={styles.homePage__postWrapper}>
            <Post
              ...
              onDump={this.props.onDump}
              onHodl={this.props.onHodl}
              onUnHodl={this.props.onUnHodl}
              onUnDump={this.props.onUnDump}
            />
          </div>
        );
      });
        ...
        <main className={styles.homePage}>
          <div className={styles.homePage__feed}>
            <NewPost
              ...
              onIncludeChart={this.props.onIncludeChart}
              includeChart={this.props.includeChart}
              onMessageSubmit={this.props.onMessageSubmit}
              onGlobalToggleChange={this.props.onGlobalToggleChange}
              globalToggle={this.props.globalToggle}
              userFirstName={this.props.userFirstName}
              userLastName={this.props.userLastName}
              userAvatar={this.props.userAvatar}
              onMessageChange={this.props.onMessageChange}
              messageCharCount={this.props.messageCharCount}
            />
            ...
            <InfiniteScroll
              ...
              next={() => {
                console.log(
                  "number of posts in data length: " + this.props.numberOfPosts
                );
                this.props.getPosts();
              }}
